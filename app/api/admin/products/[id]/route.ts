...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const allowed = ['name', 'slug', 'description', 'price', 'images', 'badge', 'category', 'letter_style', 'materials', 'care_instructions', 'production_days_min', 'production_days_max', 'stock', 'is_active', 'available_colors', 'meta_title', 'meta_description']
