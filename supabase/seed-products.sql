...
select
  ...
  4500,
  ARRAY['https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&q=80'],
  'portachupete',
  null,
...
select
  ...
  4500,
  ARRAY['https://images.unsplash.com/photo-1491013516836-7db643ee125a?w=600&q=80'],
  'portachupete',
  '💕 Para nenas',
...
select
  ...
  4500,
  ARRAY['https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=600&q=80'],
  'portachupete',
  '💙 Para nenes',
...
select
  ...
  5200,
  ARRAY['https://images.unsplash.com/photo-1519689680058-324335c77eba?w=600&q=80'],
  'portachupete',
  '🌿 Premium',
