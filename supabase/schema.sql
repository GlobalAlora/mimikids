...
-- Sample data
insert into products (slug, name, description, price, images, category, badge, materials, care_instructions, production_days_min, production_days_max, available_colors) values
(
